...
def sign_up():
    ...
    doc = {
        ...
        "profile_pic": "",
        "profile_pic_real": "profile_pics/profile.png",  # a default profile image
...
def update_profile():
    ...
    try:
        ...
        if 'file_give' in request.files:
            ...
            new_doc_posts['profile_pic_real'] = file_path
...
def delete_post():
    ...
    try:
        ...
        post_id_receive = request.form["post_id_give"]
        user_info = db.user.find_one({'username': payload.get('id')})
        postingan = db.posts.delete_one({'_id': ObjectId(post_id_receive)})
